...
const AnimatedInputWrapper = ({ children, isFocused }: { children: React.ReactNode; isFocused: boolean }) => {
  ...
  return (
    <Animated.View style={[styles.inputWrapper, animatedBorderStyle, animatedShadowStyle]}>
      {children}
    </Animated.View>
  );
};
...
export default function EditNoteScreen() {
  ...
  const [title, setTitle] = useState((params.title as string) || 'Design System Ideas');
  const [description, setDescription] = useState((params.description as string) || 'Use Poppins for headings, Inter for body. Primary color is #6C63FF. Add more glassmorphism.');
